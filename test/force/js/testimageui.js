	...
	function DisplayContentClosedFlud() {
		...
		var type_circle = g2
					.append("circle")
					.attr("cx", x_closed_flud)
					.attr("cy", y_closed_flud)
					.attr("r", 11)
				    .attr("class", "circle_type")

		/* Image of type */
		var fo_type_image = g2
					.append("foreignObject")
		    		.attr("id", "fo_image_type")
					.attr('x', x_closed_flud-12)
					.attr('y', y_closed_flud-12)
					.attr('width', 25)
					.attr('height', 25)
		...
		//xhtml
		var fo_xhtml = fo_flud
			.append('xhtml:div')
		    .attr("class", "fo_xhtml")
		 
		//div permettant un contenu centré verticalement
		var fo_div_centered = fo_xhtml
			.append('xhtml:div')
		    .attr("class", "fo_div_centered")
	
		//paragraph
		var p = fo_div_centered
			.append("p")
			.attr("id", "closed_flud_title")
			.append("h4")
