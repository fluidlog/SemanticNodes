//Récupération des noeuds et des liens depuis un RDF.
...
var socle = svg.append('svg:rect')
			...
			//https://github.com/edumbill/doap/blob/master/examples/doap-doap.rdf
			//http://jmvanel.free.fr/jmv.rdf#me
			//http://graves.cl/visualRDF/#
var myurl = "http://jmvanel.free.fr/jmv.rdf#me";
...
function dragend(d, i) {
	d3.select(this).classed("fixed", d.fixed = true)
					.select(".transparentcircle").style("stroke", "#999");
	tick();
	force.resume();
}
