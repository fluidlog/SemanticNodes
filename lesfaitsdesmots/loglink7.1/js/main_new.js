...
//  myGraph.externalStore.uri = "http://semantic-forms.cc:9111/ldp/yannick/fludy/338093ca83.ttl"; //"https://ldp.virtual-assembly.org:8443/2013/fludy/";
  ...
  // https://ldp.virtual-assembly.org:8443/2013/fludytest/

  var serverUri = "http://semantic-forms.cc:9111/ldp/yannick/fludy/";
    var contextmap = {
      "@context":{
...
//  var triplet_uri = store.save(jsonLd);
//  console.log("triplet_uri = %o",triplet_uri);
// rwwplauy : https://ldp.virtual-assembly.org:8443/2013/fludytest/4b09b182dc
// SF : http://semantic-forms.cc:9111/ldp/yannick/fludy/1520880748501-36561695290683904
    store.get("http://semantic-forms.cc:9111/ldp/yannick/fludy/1520880748501-36561695290683904").then(function(triplet)
    {
      console.log("triplet = %o",triplet);
      var toto = triplet
    });

    // store.delete(serverUri+"19bc595365").then(function(triplet)
    // {
    //   console.log("delete = %o",triplet);
    // });

    // store.delete(serverUri+"unnamed").then(function(triplet)
    // {
    //   console.log("delete = %o",triplet);
    // });


  // //window.location.hash = "http://semantic-forms.cc:9111/ldp/yannick/fludy/338093ca83.ttl"
  // window.location.hash = "https://ldp.virtual-assembly.org:8443/2013/fludy/338093ca83"
  ...
  //   // myGraph.graphName = 2a1499b5dc ou 338093ca83.ttl sur SF
